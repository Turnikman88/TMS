    ...
    public class Board : IBoard, IActivityLog
    {
        ...
        public string Name
        {
            ...
            private set
            {
                ...
                Validator.ValidateStringLenght(value.Length, Constants.BOARD_NAME_MIN_SYMBOLS, Constants.BOARD_NAME_MAX_SYMBOLS, string.Format(Constants.STRING_LENGHT_ERR, nameof(Team), Constants.BOARD_NAME_MIN_SYMBOLS, Constants.BOARD_NAME_MAX_SYMBOLS));
            }
        }
